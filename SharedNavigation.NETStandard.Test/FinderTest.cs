...
namespace SharedNavigation.NETStandard.Test
{
    ...
    public class FinderTest
    {
        ...
        [TestMethod]
        public void TestFindInjectProperty_NotFound()
        {
            assertWarning(createMessage("FinderViewModel60", "PushCommand was not found"));
        }

        [TestMethod]
        public void TestFindInjectProperty_NotCommand()
        {
            assertWarning(createMessage("FinderViewModel61", "PushCommand type not equal INavigationCommand"));
        }

        [TestMethod]
        public void TestFindInjectProperty_NotAttribute()
        {
            assertWarning(createMessage("FinderViewModel62", "PushCommand not has InjectNavigationAttribute"));
        }

        [TestMethod]
        public void TestFindInjectProperty_ReturnTrue()
        {
            assertNotWarning(createMessage("FinderViewModel63", "PushCommand was not found"));
            assertNotWarning(createMessage("FinderViewModel63", "PushCommand type not equal INavigationCommand"));
            assertNotWarning(createMessage("FinderViewModel63", "PushCommand not has InjectNavigationAttribute"));
        }
        #endregion

        #region For findRegisterNavigation
        [TestMethod]
        public void TestFindRegisterNavigation_Explicit()
        {
            assertNotWarning(createMessage("FinderView80", "not found RegisterNavigationByAutoGenerated"));
        }

        [TestMethod]
        public void TestFindRegisterNavigation_Implicit()
        {
            assertNotWarning(createMessage("FinderView81", "not found RegisterNavigationByAutoGenerated"));
        }
        #endregion
    }
}
